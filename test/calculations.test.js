...
test('Prediction: 1 minute history, 0 reading, 0 valid', () => {
  const readings = [];
  const number = 1;
  const type = 'time';
...
test('Prediction: only valid count', () => {
  const count = 'count';
  expect(calculations.getPrediction(undefined, undefined, count)).toBe(0);
});

test('Prediction: 1 count history, 0 reading, 0 valid', () => {
  const readings = [];
  const number = 1;
  const type = 'count';
  expect(calculations.getPrediction(readings, number, type)).toBe(0);
...
test('Prediction: 1 count history, 1 reading, 1 valid, at 12:00 to equal 1000W', () => {
  const readings = [
    { consumption: 1000, timestamp: '2020-10-21T12:00:00.000Z' },
  ];
  const number = 1;
...
test('Prediction: 1 count history, 3 reading, 3 valid, at 12:12 to equal 8000W', () => {
  const readings = [
    { consumption: 1000, timestamp: '2020-10-21T12:12:00.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:00:08.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:00:00.000Z' },
...
test('Prediction: 3 count history, 5 reading, 3 valid, at 12:30 to equal 500', () => {
  const readings = [
    { consumption: 1000, timestamp: '2020-10-21T12:30:00.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:29:45.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:29:35.000Z' },
...
test('Prediction: 5 count history, 3 reading, 3 valid, at 12:30 to equal 500', () => {
  const readings = [
    { consumption: 1000, timestamp: '2020-10-21T12:30:00.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:29:45.000Z' },
    { consumption: 1000, timestamp: '2020-10-21T12:29:35.000Z' },
...
// getPowerAvailable
test('PowerAvailable: Limit: 4000, used 0, 60 minutes left = 4000', () => {
    expect(calculations.getPowerAvailable(4000, 0, '2020-10-21T12:00:00.000Z')).toBe(4000);
});

test('PowerAvailable: Limit: 4000, used 2000, 60 minutes left = 4000', () => {
    expect(calculations.getPowerAvailable(4000, 2000, '2020-10-21T12:00:00.000Z')).toBe(2000);
});

test('PowerAvailable: Limit: 4000, used 2000, 30 minutes left = 4000', () => {
  expect(calculations.getPowerAvailable(4000, 2000, '2020-10-21T12:30:00.000Z')).toBe(4000);
});

test('PowerAvailable: Limit: 4000, used 2000, 15 minutes left = 8000', () => {
    expect(calculations.getPowerAvailable(4000, 2000, '2020-10-21T12:45:00.000Z')).toBe(8000);
});

test('PowerAvailable: Limit: 4000, used 0, 30 minutes left = 8000', () => {
    expect(calculations.getPowerAvailable(4000, 0, '2020-10-21T12:30:00.000Z')).toBe(8000);
});

test('PowerAvailable: Limit: 2000, used 4000, 30 minutes left = -4000 (need to deliver back to grid)', () => {
    expect(calculations.getPowerAvailable(2000, 4000, '2020-10-21T12:30:00.000Z')).toBe(-4000);
});

test('PowerAvailable: Limit: 0, used -1000 (produced more than used), 30 minutes left = 2000', () => {
    expect(calculations.getPowerAvailable(0, -1000, '2020-10-21T12:30:00.000Z')).toBe(2000);
});

test('PowerAvailable: Limit: 1000, used -1000 (produced more than used), 30 minutes left = 4000', () => {
    expect(calculations.getPowerAvailable(1000, -1000, '2020-10-21T12:30:00.000Z')).toBe(4000);
});

test('PowerAvailable: Limit: -1000, used -1000 (produced more than used), 30 minutes left = 0', () => {
    expect(calculations.getPowerAvailable(-1000, -1000, '2020-10-21T12:30:00.000Z')).toBe(0);
});

test('PowerAvailable: Limit: -1000, used 1000 (want to deliver back to grid but has used), 30 minutes left = -4000', () => {
    expect(calculations.getPowerAvailable(-1000, 1000, '2020-10-21T12:30:00.000Z')).toBe(-4000);
});
